    ...
    <div class="row gx-0">
        ...
        <div class="col-lg-9 py-3 pe-3 ps-3 ps-lg-0">
            ...
            <div class="row gx-3">
                ...
                $sql = "SELECT a.sender_id, a.reciver_id, b.first_name, b.last_name, b.image FROM messages a INNER JOIN employies b ON a.sender_id = b.user_id OR a.reciver_id = b.user_id WHERE a.sender_id = '$user_id' OR a.reciver_id = '$user_id' GROUP BY b.user_id ";
