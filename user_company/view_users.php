    ...
    <div class="row gx-0">
        ...
        <div class="col-lg-9 py-3 pe-3 ps-3 ps-lg-0">
                ...
                <div class="col-12">
                    <div class="card-basic mb-3">
                        <div class="input-group">
                            <input class="form-control" type="text" name="search_q" onkeyup="adminSearchEmployee()"
                    ...
                    function viewEmployeeDetails(x) {
            ...
            <div id="company_wrap" class="row gx-3">
                <?php
                $sql = "SELECT a.first_name, a.last_name, a.image, a.user_id, b.state, b.email FROM employies a INNER JOIN users b ON a.user_id = b.user_id";
