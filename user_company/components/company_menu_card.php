<div id="co_m_1" onclick="setMenu('co_m_1_wrap')" class="menu-item mb-2 company-prim">
    <div class="activebar <?php if($admin_menu == "co_m_1"){ echo "active"; }?>"></div>
...
<div id="co_m_1_wrap" class="<?php if($admin_menu == "co_m_1"){ echo "no-fade-jq"; }?>">
    ...
    <a href="edit_company_details.php" class="no-link ">
        <div id="co_m_1_2" class="menu-item mb-2 ms-4 company-sec">
            <div class="activebar <?php if($admin_submenu == "co_m_1_2"){ echo "active"; }?>"></div>
...
<div id="co_m_2" onclick="setMenu('co_m_2_wrap')" class="menu-item mb-2 company-prim">
    <div class="activebar <?php if($admin_menu == "co_m_2"){ echo "active"; }?>"></div>
    <div class=" ms-4 name active">MANAGE JOBS</div>
</div>
<div id="co_m_2_wrap" class="<?php if($admin_menu == "co_m_2"){ echo "no-fade-jq"; }?>">
    <a href="co_add_new_job.php" class="no-link ">
        <div id="co_m_2_1" class="menu-item mb-2 ms-4 company-sec">
            <div class="activebar <?php if($admin_submenu == "co_m_2_1"){ echo "active"; }?>"></div>
...
<div id="co_m_3" onclick="setMenu('co_m_3_wrap')" class="menu-item mb-2 company-prim">
    <div class="activebar <?php if($admin_menu == "co_m_3"){ echo "active"; }?>"></div>
    <div class=" ms-4 name active">MANAGE USERS</div>
</div>
<div id="co_m_3_wrap" class="<?php if($admin_menu == "co_m_3"){ echo "no-fade-jq"; }?>">
    <a href="" class="no-link ">
        <div id="co_m_3_1" class="menu-item mb-2 ms-4 company-sec">
            <div class="activebar <?php if($admin_submenu == "co_m_3_1"){ echo "active"; }?>"></div>
            <div class=" ms-4 name active">VIEW APPLICATIONS</div>
        </div>
    </a>
    <a href="" class="no-link ">
        <div id="co_m_3_2" class="menu-item mb-2 ms-4 company-sec">
            <div class="activebar <?php if($admin_submenu == "co_m_3_2"){ echo "active"; }?>"></div>
            <div class=" ms-4 name active">SEARCH EMPLOYEES</div>
        </div>
    </a>
    <a href="" class="no-link ">
        <div id="co_m_3_3" class="menu-item mb-2 ms-4 company-sec">
            <div class="activebar <?php if($admin_submenu == "co_m_3_3"){ echo "active"; }?>"></div>
