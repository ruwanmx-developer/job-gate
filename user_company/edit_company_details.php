...
<body>
    ...
    <div class="row gx-0">
        ...
        <div class="col-lg-9 py-3 pe-3 ps-3 ps-lg-0">
            ...
            $sql = "SELECT a.user_id, a.name, a.address, a.district_id, a.description, a.logo, a.website, a.linkedin, a.mobile, b.email FROM companies a INNER JOIN users b ON a.user_id = b.user_id WHERE a.user_id='$id'";
                        ...
                        <div class="col-12">
                            <label for="upload_image">
                                <div class="form-control upload text-center">
                                    <?php $image = ($row['logo'] == NULL) ? "site_images/home.png" : "uploads/user/" . $row['logo']?>
